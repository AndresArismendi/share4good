...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { reference_answer: @reference.reference_answer, reference_comment: @reference.reference_comment, reference_date: @reference.reference_date, reference_mark: @reference.reference_mark }
    end
  ...
  test "should update reference" do
    patch :update, id: @reference, reference: { reference_answer: @reference.reference_answer, reference_comment: @reference.reference_comment, reference_date: @reference.reference_date, reference_mark: @reference.reference_mark }
    assert_redirected_to reference_path(assigns(:reference))
  end
